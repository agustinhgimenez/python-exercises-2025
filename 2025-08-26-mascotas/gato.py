...
class Gato(Mascota):
    def __init__(self, nombre, fecha_ingreso, tiempo_rehabilitacion=180, alojamiento="Cucha"):
    ...
    def __str__(self):
        return (f"Nombre del Gato: {self.nombre}, Fecha de Ingreso: {self.fecha_ingreso}, "
